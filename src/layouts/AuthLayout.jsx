      ...
      <div className="flex min-h-screen w-full items-center justify-center px-5 md:px-10 bg-primary-50">
        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col items-center text-center mb-4">
            <img src="/aleo-logos/SVG/primary-logo-light.svg" className="w-36" alt="PrivatePay" />
            <div className="font-aleo text-md font-medium opacity-50 mt-2">
          ...
          <div className="flex flex-col items-center mt-2">
            <div className="mt-8 opacity-60 font-aleo text-sm">Powered by</div>
            <div className="mt-2">
              <img src="/aleo-badges/badge-dark.svg" className="h-8 w-auto object-contain" alt="Built with Aleo" />
            </div>
          </div>
        </div>
      </div>
