    ...
    >
      <ModalContent className="relative flex flex-col rounded-4xl items-center justify-center gap-5 p-6">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          />
          <p className="font-aleo text-2xl font-bold text-primary">PRIVATEPAY</p>
        </div>

        <h1 className="font-aleo font-medium text-xl text-[#19191B]">Your QR Code</h1>
        ...
        <p className="font-aleo text-sm text-gray-500">Supported network: Aleo</p>
